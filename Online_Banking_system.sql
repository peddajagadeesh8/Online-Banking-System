...
INSERT INTO `card` VALUES (1,'1234567812345678','Amit Sharma','2025-12-31',123,'Credit','State Bank of India',1),
  (2,'2345678923456789','Priya Singh','2024-11-30',234,'Debit','HDFC Bank',2),
  (3,'3456789034567890','Rahul Verma','2026-10-31',345,'Credit','ICICI Bank',3),
  (4,'4567890145678901','Anjali Mehta','2023-09-30',456,'Debit','Axis Bank',4),
  (5,'5678901256789012','Vikram Patel','2025-08-31',567,'Credit','Punjab National Bank',5),
  (6,'6789012367890123','Sneha Gupta','2024-07-31',678,'Debit','Bank of Baroda',6),
  (7,'7890123478901234','Rohit Kumar','2026-06-30',789,'Credit','Canara Bank',7),
  (8,'8901234589012345','Neha Joshi','2023-05-31',890,'Debit','Union Bank of India',8),
  (9,'9012345690123456','Arjun Reddy','2025-04-30',901,'Credit','Kotak Mahindra Bank',9),
  (10,'0123456701234567','Kiran Desai','2024-03-31',12,'Debit','Yes Bank',10),
  (11,'1234567812345679','Suman Rao','2026-12-31',123,'Credit','State Bank of India',11),
  (12,'2345678923456790','Ravi Shankar','2024-11-30',234,'Debit','HDFC Bank',12),
  (13,'3456789034567901','Asha Kumari','2026-10-31',345,'Credit','ICICI Bank',13),
  (14,'4567890145679012','Vijay Anand','2023-09-30',456,'Debit','Axis Bank',14),
  (15,'5678901256780123','Pooja Mishra','2025-08-31',567,'Credit','Punjab National Bank',15),
  (16,'6789012367891234','Suresh Nair','2024-07-31',678,'Debit','Bank of Baroda',16),
  (17,'7890123478902345','Lakshmi Iyer','2026-06-30',789,'Credit','Canara Bank',17),
  (18,'8901234589013456','Manoj Jain','2023-05-31',890,'Debit','Union Bank of India',18),
  (19,'9012345690124567','Divya Menon','2025-04-30',901,'Credit','Kotak Mahindra Bank',19),
  (20,'0123456701235678','Ramesh Kumar','2024-03-31',12,'Debit','Yes Bank',20),
  (21,'1234567812346789','Sunita Yadav','2025-12-31',123,'Credit','State Bank of India',21),
  (22,'2345678923457890','Anil Kapoor','2024-11-30',234,'Debit','HDFC Bank',22),
  (23,'3456789034568901','Meena Rani','2026-10-31',345,'Credit','ICICI Bank',23),
  (24,'4567890145679013','Karthik Reddy','2023-09-30',456,'Debit','Axis Bank',24),
  (25,'5678901256780124','Snehal Patel','2025-08-31',567,'Credit','Punjab National Bank',25),
  (26,'7890123478902346','Priya Nair','2026-06-30',789,'Credit','Canara Bank',26),
  (27,'8901234589013457','Amitabh Bachchan','2023-05-31',890,'Debit','Union Bank of India',27),
  (28,'9012345690124568','Radhika Apte','2025-04-30',901,'Credit','Kotak Mahindra Bank',28),
  (29,'0123456701235679','Shahrukh Khan','2024-03-31',12,'Debit','Yes Bank',29),
  (30,'1234567812346790','Deepika Padukone','2025-12-31',123,'Credit','State Bank of India',30),
  (31,'2345678923457901','Ranveer Singh','2024-11-30',234,'Debit','HDFC Bank',31),
  (32,'3456789034568012','Alia Bhatt','2026-10-31',345,'Credit','ICICI Bank',32),
  (33,'4567890145679123','Katrina Kaif','2023-09-30',456,'Debit','Axis Bank',33),
  (34,'5678901256780234','Ranbir Kapoor','2025-08-31',567,'Credit','Punjab National Bank',34),
  (35,'6789012367891345','Aishwarya Rai','2024-07-31',678,'Debit','Bank of Baroda',35),
  (36,'7890123478902456','Hrithik Roshan','2026-06-30',789,'Credit','Canara Bank',36),
  (37,'8901234589013567','Priyanka Chopra','2023-05-31',890,'Debit','Union Bank of India',37),
  (38,'9012345690124678','Akshay Kumar','2025-04-30',901,'Credit','Kotak Mahindra Bank',38),
  (39,'0123456701235789','Kareena Kapoor','2024-03-31',12,'Debit','Yes Bank',39),
  (40,'1234567812346901','Saif Ali Khan','2025-12-31',123,'Credit','State Bank of India',40),
  (41,'2345678923457012','Salman Khan','2024-11-30',234,'Debit','HDFC Bank',41),
  (42,'3456789034568123','Anushka Sharma','2026-10-31',345,'Credit','ICICI Bank',42),
  (43,'4567890145679234','Virat Kohli','2023-09-30',456,'Debit','Axis Bank',43),
  (44,'5678901256780345','Yuvraj Singh','2025-08-31',567,'Credit','Punjab National Bank',44),
  (45,'6789012367891456','MS Dhoni','2024-07-31',678,'Debit','Bank of Baroda',45),
  (46,'7890123478902567','Sachin Tendulkar','2026-06-30',789,'Credit','Canara Bank',46),
  (47,'8901234589013678','Sourav Ganguly','2023-05-31',890,'Debit','Union Bank of India',47),
  (48,'9012345690124789','Kapil Dev','2025-04-30',901,'Credit','Kotak Mahindra Bank',48),
  (49,'0123456701236890','Sunil Gavaskar','2024-03-31',12,'Debit','Yes Bank',49),
  (50,'1234567812347012','Ravi Shastri','2025-12-31',123,'Credit','State Bank of India',50),
  (51,'2345678923458123','Rahul Dravid','2024-11-30',234,'Debit','HDFC Bank',51),
  (52,'3456789034569234','VVS Laxman','2026-10-31',345,'Credit','ICICI Bank',52),
  (53,'4567890145670345','Anil Kumble','2023-09-30',456,'Debit','Axis Bank',53),
  (54,'5678901256781456','Harbhajan Singh','2025-08-31',567,'Credit','Punjab National Bank',54),
  (55,'6789012367892567','Zaheer Khan','2024-07-31',678,'Debit','Bank of Baroda',55),
  (56,'7890123478903678','Virender Sehwag','2026-06-30',789,'Credit','Canara Bank',56),
  (57,'8901234589014789','Gautam Gambhir','2023-05-31',890,'Debit','Union Bank of India',57),
  (58,'9012345690125890','Rohit Sharma','2025-04-30',901,'Credit','Kotak Mahindra Bank',58),
  (59,'0123456701237901','Shikhar Dhawan','2024-03-31',12,'Debit','Yes Bank',59),
  (60,'1234567812348123','Ajinkya Rahane','2025-12-31',123,'Credit','State Bank of India',60),
  (61,'2345678923459234','KL Rahul','2024-11-30',234,'Debit','HDFC Bank',61),
  (62,'3456789034560345','Rishabh Pant','2026-10-31',345,'Credit','ICICI Bank',62),
  (63,'4567890145671456','Hardik Pandya','2023-09-30',456,'Debit','Axis Bank',63),
  (64,'5678901256782567','Ravindra Jadeja','2025-08-31',567,'Credit','Punjab National Bank',64),
  (65,'6789012367893678','Bhuvneshwar Kumar','2024-07-31',678,'Debit','Bank of Baroda',65),
  (66,'7890123478904789','Jasprit Bumrah','2026-06-30',789,'Credit','Canara Bank',66),
  (67,'8901234589015890','Mohammed Shami','2023-05-31',890,'Debit','Union Bank of India',67),
  (68,'9012345690126901','Ishant Sharma','2025-04-30',901,'Credit','Kotak Mahindra Bank',68),
  (69,'0123456701238012','Yuzvendra Chahal','2024-03-31',12,'Debit','Yes Bank',69),
  (70,'1234567812349234','Kuldeep Yadav','2025-12-31',123,'Credit','State Bank of India',70),
  (71,'2345678923450345','Shreyas Iyer','2024-11-30',234,'Debit','HDFC Bank',71),
  (72,'3456789034561456','Suresh Raina','2026-10-31',345,'Credit','ICICI Bank',72),
  (73,'4567890145672567','Dinesh Karthik','2023-09-30',456,'Debit','Axis Bank',73),
  (74,'5678901256783678','Manish Pandey','2025-08-31',567,'Credit','Punjab National Bank',74),
  (75,'6789012367894789','Umesh Yadav','2024-07-31',678,'Debit','Bank of Baroda',75),
  (76,'7890123478905890','Washington Sundar','2026-06-30',789,'Credit','Canara Bank',76),
  (77,'8901234589016901','Navdeep Saini','2023-05-31',890,'Debit','Union Bank of India',77),
  (78,'9012345690127012','Shardul Thakur','2025-04-30',901,'Credit','Kotak Mahindra Bank',78),
  (79,'0123456701239123','Deepak Chahar','2024-03-31',12,'Debit','Yes Bank',79),
  (80,'1234567812340345','Prithvi Shaw','2025-12-31',123,'Credit','State Bank of India',80),
  (81,'2345678923451456','Mayank Agarwal','2024-11-30',234,'Debit','HDFC Bank',81),
  (82,'3456789034562567','Hanuma Vihari','2026-10-31',345,'Credit','ICICI Bank',82),
  (83,'4567890145673678','Wriddhiman Saha','2023-09-30',456,'Debit','Axis Bank',83),
  (84,'5678901256784789','Ravichandran Ashwin','2025-08-31',567,'Credit','Punjab National Bank',84),
  (85,'6789012367895890','Axar Patel','2024-07-31',678,'Debit','Bank of Baroda',85),
  (86,'7890123478906901','Mohammed Siraj','2026-06-30',789,'Credit','Canara Bank',86),
  (87,'8901234589017012','Shivam Dube','2023-05-31',890,'Debit','Union Bank of India',87),
  (88,'9012345690128123','Rahul Tewatia','2025-04-30',901,'Credit','Kotak Mahindra Bank',88),
  (89,'0123456701239234','Varun Chakravarthy','2024-03-31',12,'Debit','Yes Bank',89),
  (90,'1234567812340456','Sanju Samson','2025-12-31',123,'Credit','State Bank of India',90),
  (91,'2345678923452567','Ishan Kishan','2024-11-30',234,'Debit','HDFC Bank',91),
  (92,'3456789034563678','Nitish Rana','2026-10-31',345,'Credit','ICICI Bank',92),
  (93,'4567890145674789','Devdutt Padikkal','2023-09-30',456,'Debit','Axis Bank',93),
  (94,'5678901256785890','Suryakumar Yadav','2025-08-31',567,'Credit','Punjab National Bank',94),
  (95,'6789012367896901','T. Natarajan','2024-07-31',678,'Debit','Bank of Baroda',95),
  (96,'7890123478907012','Ruturaj Gaikwad','2026-06-30',789,'Credit','Canara Bank',96),
  (97,'8901234589018123','Shubman Gill','2023-05-31',890,'Debit','Union Bank of India',97),
  (98,'9012345690129234','Arshdeep Singh','2025-04-30',901,'Credit','Kotak Mahindra Bank',98),
  (99,'0123456701240345','Chetan Sakariya','2024-03-31',12,'Debit','Yes Bank',99),
  (100,'1234567812341567','Rahul Chahar','2025-12-31',123,'Credit','State Bank of India',100);
